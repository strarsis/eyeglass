...
var makeFsImporter = require("./fs_importer");
...
Eyeglass.prototype = {
  ...
  defaultFsSandbox: function(options) {
    return options.root;
  },
  root: function() {
  ...
  sassOptions: function() {
    ...
    var fsImporter = makeFsImporter(this, this.sass, opts, assetImporter);
    var moduleImporter = makeModuleImporter(this, this.sass, opts, fsImporter);
  ...
  normalizeOptions: function(options) {
    ...
    if (options.fsSandbox === true) {
      options.fsSandbox = this.defaultFsSandbox(options);
    }
    if (typeof options.fsSandbox === "string") {
      options.fsSandbox = [options.fsSandbox];
    }
    return options;
  }
};
